...
q	        quality     0 Ð 100	                Compression quality.
...
f	        filters     too many to mention         LetÕs you apply image filters to change the resized picture. For instance you can change brightness/ contrast or even blur the image
...
if( file_exists(dirname(__FILE__) . '/image/index.php'))	require_once('/image/index.php');
